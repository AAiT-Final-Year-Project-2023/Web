...
const Card = () => {
  return (
    <div className="flex flex-wrap justify-center">
      {/* Card 1 */}
      <div className="w-80 max-w-xs mx-4 my-8 bg-white rounded-lg shadow-md">
        <img
        ...
        <div className="p-4">
          ...
          <div className="flex justify-end mt-4">
            ...
            <button className="bg-gray-500 hover:bg-gray-600 text-white ml-2 px-4 py-2 rounded">
              Button 2
            </button>
          </div>
        </div>
...
//               <h3 className='font-semibold text-3xl'>Recently Viewed</h3>
...
//               <h3 className='font-semibold text-3xl'>Requests</h3>
//               <ul className="grid grid-cols-1 xl:grid-cols-3 gap-y-10 gap-x-6 items-start p-8">
//     <li className="relative flex flex-col sm:flex-row xl:flex-col items-start">
//         <div className="order-1 sm:ml-6 xl:ml-0">
//             <h3 className="mb-1 text-slate-900 font-semibold dark:text-slate-200">
