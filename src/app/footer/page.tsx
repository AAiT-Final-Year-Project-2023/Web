...
export default function footer(){
    ...
    <div className="w-full max-w-screen-xl p-4 py-6 lg:py-8">
          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              <div>
                  ...
                  <ul className="text-gray-600 dark:text-gray-400 font-medium">
                      <li className="mb-4">
                          <a href="/datasets" className="hover:underline ">Dataset</a>
                      </li>
                      <li>
                          <a href="./requests" className="hover:underline">Data Request</a>
                      </li>
                  </ul>
              </div>
              <div>
                  <h2 className="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Collection</h2>
                  <ul className="text-gray-600 dark:text-gray-400 font-medium">
                      <li className="mb-4">
                          <a href="" className="hover:underline "></a>
                      </li>
                      <li>
                          <a href="" className="hover:underline">Contributions</a>
                      </li>
                      <li>
                          <a href="" className="hover:underline">Lablings</a>
                      </li>
                      <li>
              ...
              <div>
                  ...
                  <ul className="text-gray-600 dark:text-gray-400 font-medium">
                      ...
                      <li className='grid space-x-1 lg:grid-cols-4 mt-2'>
      ...
      <div className="sm:flex sm:items-center sm:justify-center">
          <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://flowbite.com/" className="hover:underline">Data Shelf™</a>. All Rights Reserved.
          </span>
