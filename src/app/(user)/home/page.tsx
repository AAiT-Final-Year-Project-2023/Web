...
import { REQUEST_POST_URL, getMany as getManyRequestPosts } from '@/common/api/requestPost';
...
export default async function Page() {
    ...
    const requestPostUrl = REQUEST_POST_URL + `?page=${1}&limit=${3}&sortByDate=ASC`;
    const requestPosts: Promise<RequestPostResult> = getManyRequestPosts(requestPostUrl, token);
    ...
    return (
        <main className="">
            ...
            <section>
                ...
                <Suspense fallback={<div><span className="loading loading-bars loading-lg"></span>
</div>}>
                    {/* @ts-expect-error Server Component */}
                    <HomeRequestPostsContainer props={{promise: requestPosts, user}}/> 
                </Suspense> 
            ...
            <section>
                ...
                <Suspense fallback={<div><span className="loading loading-bars loading-lg"></span>
                    ...
                    {/* @ts-expect-error Server Component */}
                    <HomeDatasetsContainer props={{promise: datasets, user}}/> 
                </Suspense> 
